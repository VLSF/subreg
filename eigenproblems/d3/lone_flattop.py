...
if __name__ == "__main__":
    ...
    for i, key in enumerate(keys):
        ...
        jnp.savez(f"lone_flattop/lone_flattop_{i}.npz", eigenvalues=data["eigenvalues"], eigenvectors=data["eigenvectors"], features=data["features"], A_data=data["A_data"])
        if i == 0:
            jnp.savez(f"lone_flattop/lone_flattop_global.npz", A_indices=data["A_indices"], coordinates=data["coordinates"])